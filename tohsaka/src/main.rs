...
use tohsaka_core::attention::{Attention, AttentionConfig};
use tohsaka_core::character;
use tohsaka_core::init_logging;
use tohsaka_core::knowledge::KnowledgeBase;
use tohsaka_core::{agent::Agent, clients::discord::DiscordClient, clients::twitter::TwitterClient, clients::telegram::TelegramClient, clients::direct::DirectClient};
...
struct Args {
    ...
    #[arg(long, default_value = "tohsaka/src/characters/tohsaka.toml")]
    character: String,

    /// Path to database
    #[arg(long, default_value = "tohsaka.db")]
    db_path: String,
